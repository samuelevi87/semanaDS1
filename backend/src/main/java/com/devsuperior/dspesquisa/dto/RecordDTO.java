...
public class RecordDTO implements Serializable {
    ...
    public RecordDTO id(Long id) {
        this.id = id;
        return this;
    }

    public RecordDTO moment(Instant moment) {
        this.moment = moment;
        return this;
    }

    public RecordDTO name(String name) {
        this.name = name;
        return this;
    }

    public RecordDTO age(Integer age) {
        this.age = age;
        return this;
    }

    public RecordDTO gameTitle(String gameTitle) {
        this.gameTitle = gameTitle;
        return this;
    }

    public RecordDTO gamePlatform(Platform gamePlatform) {
        this.gamePlatform = gamePlatform;
        return this;
    }

    public RecordDTO genreName(String genreName) {
        this.genreName = genreName;
        return this;
    }
